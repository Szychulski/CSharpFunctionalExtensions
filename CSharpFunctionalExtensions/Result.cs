...
namespace CSharpFunctionalExtensions
{
	...
	public struct Result : ISerializable
	{
		...
		[DebuggerStepThrough]
		public static Result<TValue, TError> Success<TValue, TError>(TValue value) where TError : class
		{
		...
		/// <param name="results">List of results.</param>
		[DebuggerStepThrough]
		public static Result Combine(string errorMessagesSeparator, IEnumerable<Result> results)
		{
		...
		{
			return Combine(errorMessagesSeparator, (IEnumerable<Result>)results);
		}
